...
const Thyroid = () => {
    ...
    const message = whatsappMessage.thyroidPlan
                        ...
                        <div className="lg:w-1/2 p-8 md:p-10">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                    Optimize Metabolism & Hormonal Health
                                </p>
                            </div>
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                ...
                                <div className="flex-grow">
                                    <p className="text-lg text-gray-700 mb-6">
                                        Support thyroid function naturally with a diet customized for your condition.
                                    </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Balanced Nutrition</h4>
                                            <p className="text-gray-600 text-sm">Anti-inflammatory foods like fruits, vegetables, and lean proteins.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Adjust Meal Choices</h4>
                                            <p className="text-gray-600 text-sm">Plans tailored for hypothyroidism and hyperthyroidism</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Improve nutritional deficiencies affecting the thyroid.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">100% home-cooked, natural diet.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Thyroid Care Sheet</h4>
                                            <p className="text-gray-600 text-sm">Expert tips for thyroid health and weight management.</p>
                                        </div>
                                    </div>
                                </div>
