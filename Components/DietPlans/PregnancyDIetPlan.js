                            ...
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                ...
                                <div className="flex-grow">
                                    <p className="text-lg text-gray-700 mb-6">
                                        Ensure the best nutrition for you and your baby with a balanced pregnancy meal plan.
                                    </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Balanced Whole Foods</h4>
                                            <p className="text-gray-600 text-sm">Fruits, vegetables, whole grains, and lean proteins.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Folate-Rich Foods</h4>
                                            <p className="text-gray-600 text-sm">Support fetal development with leafy greens, beans, and grains.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Promote blood and bone health with dairy and fortified foods.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Include omega-3s (fish, flaxseeds) for baby’s brain development.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Pregnancy Care Sheet</h4>
                                            <p className="text-gray-600 text-sm">Expert tips on nutrition and well-being during pregnancy.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
