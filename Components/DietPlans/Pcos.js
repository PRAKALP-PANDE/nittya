                            ...
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                <div className="relative w-full md:w-48 h-48 flex-shrink-0 rounded-2xl overflow-hidden shadow-md">
                                    <Image
                                        width={500}
                                        height={500}
                                        src="/nutiitionplan/pcodpcos.png"
                                ...
                                <div className="flex-grow">
                                    <p className="text-lg text-gray-700 mb-6">
                                        Manage PCOS/PCOD naturally by focusing on hormone-balancing foods.
                                    </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Low-Glycemic, High-Fiber Diet</h4>
                                            <p className="text-gray-600 text-sm">Control insulin resistance and blood sugar spikes.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Healthy Fats & Lean Proteins</h4>
                                            <p className="text-gray-600 text-sm">Support hormone regulation and reduce inflammation.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Sustainable fat loss strategies for long-term health.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">PCOS Care Sheet</h4>
                                            <p className="text-gray-600 text-sm">Tips for managing symptoms, fertility, and cycle regularity.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Only fresh, home-cooked meals.</p>
                                        </div>
                                    </div>
                                </div>
