                            ...
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                ...
                                <div className="flex-grow">
                                    <p className="text-lg text-gray-700 mb-6">
                                        Manage hypertension and cholesterol naturally with a balanced diet rich in heart-friendly foods.
                                    </p>
                                    <div className="bg-green-50 p-4 rounded-xl mb-6">
                                        <div className="flex items-center justify-between">
                                            <span className="font-medium">3 Months Plan (13 Weeks)</span>
                                            <span className="font-bold text-[#166534]">₹4,999</span>
                                        </div>
                                    </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Increase Fiber Intake</h4>
                                            <p className="text-gray-600 text-sm">Whole grains, vegetables, and fruits to support heart health</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Omega-3 rich foods while reducing saturated fats</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Sodium Control</h4>
                                            <p className="text-gray-600 text-sm">Reduced salt intake for better blood pressure</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Only fresh, home-cooked meals - no supplements</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Daily Meal Plans</h4>
                                            <p className="text-gray-600 text-sm">Structured meals for easy implementation</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900 mb-1">Care Sheet</h4>
                                            <p className="text-gray-600 text-sm">Expert guidance on lifestyle changes</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
