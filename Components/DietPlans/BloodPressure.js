                    ...
                    <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                        ...
                        <div className="flex-grow sm:pl-8">
                            <p className="mb-4 text-lg">
                                Manage hypertension and cholesterol naturally with a balanced diet rich in heart-friendly foods.</p>
                ...
                <div className="p-2 lg:w-1/2 md:w-full flex flex-col">
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Increase Fiber</h3>
                                <p className="text-lg leading-6 font-light">Whole grains, vegetables, and fruits to support heart health.</p>
                            </div>
                        </div>
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="text-lg leading-6 font-light">WhInclude omega-3s, reduce saturated fats to improve cholesterol levels.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Manage Sodium</h3>
                                <p className="text-lg leading-6 font-light">Reduce salt intake for better blood pressure control.</p>
                            </div>
                        </div>
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="text-lg leading-6 font-light">Structured meals and recipes for easy implementation.</p>
                            </div>
                        </div>
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">BP & Cholesterol Care Sheet</h3>
                                <p className="text-lg leading-6 font-light">Expert guidance on lifestyle changes.</p>
                            </div>
                        </div>
                    </div>
