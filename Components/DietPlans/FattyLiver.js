                    ...
                    <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                        ...
                        <div className="flex-grow sm:pl-8">
                            <p className="mb-4 text-lg">
                                Support liver health and reduce fat accumulation with an anti-inflammatory, low-carb diet.</p>
                ...
                <div className="p-2 lg:w-1/2 md:w-full flex flex-col">
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Low-Sugar, Low-Carb Diet</h3>
                                <p className="text-lg leading-6 font-light">Reduce refined carbs and added sugars.</p>
                            </div>
                        </div>
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="text-lg leading-6 font-light">Include omega-3s (fish, flaxseeds), limit trans fats.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="text-lg leading-6 font-light">Whole grains, legumes, and vegetables to support liver function.</p>
                            </div>
                        </div>
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                ...
                                <p className="text-lg leading-6 font-light">Only whole, natural foods.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-2 md:w-full flex md:flex-grow md:flex-row flex-col">
                        <div className="flex lg:mx-2 lg:w-1/2 relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Fatty Liver Care Sheet</h3>
                                <p className="text-lg leading-6 font-light">Comprehensive tips for liver detox and repair.</p>
                            </div>
                        </div>
                    </div>
