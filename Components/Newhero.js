...
export default function Newhero() {
    ...
    return (
        <section className="relative overflow-hidden bg-gradient-to-br from-[#f0fdf4] via-[#ecfdf5] to-[#d1fae5] py-28 px-4">
            {/* Decorative elements */}
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        ...
                        <p className="text-lg md:text-xl text-gray-700 max-w-lg leading-relaxed">
                            Scientifically crafted nutrition plans personalized for your unique needs, helping you achieve sustainable wellness and vitality.
                        </p>
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="relative w-full h-[450px] overflow-hidden rounded-3xl shadow-2xl group">
                            <div className="absolute inset-0 bg-gradient-to-br from-[#2d9155]/10 to-[#166534]/10 z-10"></div>
                            <img
                        ...
                        {/* Floating stats */}
                        <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-xl shadow-xl border border-gray-100 hidden lg:block animate-float">
                        ...
                        <div className="absolute -top-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-gray-100 hidden lg:block animate-float-delay">
