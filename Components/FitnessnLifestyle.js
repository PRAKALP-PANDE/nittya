        ...
        <section className="py-10 md:py-20 bg-gray-50">
            <div className="container px-5 mx-auto flex flex-wrap">
                <h2 className="mb-10 md:mb-16 text-4xl sm:text-5xl md:text-6xl cookie-regular font-normal leading-16 text-[#2f9457] text-center w-full">
                    Women's Diet Plan – Simple & Balanced Nutrition
                </h2>
                        ...
                        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            ...
                            <div className="flex-grow sm:pl-8">
                                ...
                                <p className="mb-4 text-lg">
                                    We offer easy-to-follow, homemade diet plans tailored for women's health.
                                </p>
                    ...
                    <div className="p-4 lg:w-1/2 md:w-full">
                        <div className="flex relative pb-6 items-start">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Simple, Homemade Meals</h3>
                                <p className="text-lg leading-6 font-light">Nutritious & easy-to-cook recipes.</p>
                            </div>
                        </div>
                        <div className="flex relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Fix Nutritional Deficiencies</h3>
                                <p className="text-lg leading-6 font-light">Boost iron, calcium, hemoglobin & vitamins.</p>
                            </div>
                        </div>
                        <div className="flex relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Hormonal Balance</h3>
                                <p className="text-lg leading-6 font-light">Supports PCOS, thyroid & menstrual health.</p>
                            </div>
                        </div>
                        <div className="flex relative pb-6 items-start">
                            <div className="flex-shrink-0 w-6 h-6 text-2xl bg-[#31985a] text-white rounded-full inline-flex items-center justify-center relative z-10 mt-1">
                            ...
                            <div className="flex-grow pl-4">
                                <h3 className="font-medium text-xl text-gray-900 mb-1">Fat & Inch Loss</h3>
                                <p className="text-lg leading-6 font-light">Achieve sustainable weight management.</p>
                            </div>
                        </div>
                    </div>
                </div>
